...
// make this contract inherits from: ERC721URIStorage contract and Ownable contract
contract Assignment8 is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("RaefNFT", "RAEF") Ownable(msg.sender) {
        // initialize the _tokenIdCounter to 0
        _tokenIdCounter = 0;
    }
